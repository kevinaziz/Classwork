...
//
// This program draws a white L whose orientation can be changed by the user. Animation 
// between the start and target orientations of the white L is shown by a moving yellow L. 
...
//
// Interaction:
// Press the x, X, y, Y, z, Z keys to rotate the white L.
...
void printInteraction(void)
{
   ...
   cout << "Press the x, X, y, Y, z, Z keys to rotate the white L." << endl
