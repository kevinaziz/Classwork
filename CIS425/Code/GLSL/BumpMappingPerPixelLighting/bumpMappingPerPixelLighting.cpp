//////////////////////////////////////////////////////////////////////////////////////////
// bumpMappingPerPixelLighting.cpp
//
...
// implement per-pixel lighting, also called Phong shading, where vertex normal values 
// are interpolated over interior pixels before being applied to diffuse and specular 
// calculations.
//
// Interaction:
...
int main(int argc, char **argv) 
{
   ...
   glutCreateWindow("bumpMappingPerPixelLighting.cpp");
   setup();
